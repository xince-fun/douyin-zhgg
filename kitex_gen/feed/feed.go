...
type DouyinFeedResponse struct {
	VedioList []*Video  `thrift:"vedio_list,1,required" frugal:"1,required,list<Video>" json:"vedio_list"`
...
func (p *DouyinFeedResponse) DeepEqual(ano *DouyinFeedResponse) bool {
	...
	if !p.Field1DeepEqual(ano.VedioList) {
		return false
	}
...
func (p *DouyinFeedResponse) Field1DeepEqual(src []*Video) bool {
...
func (p *DouyinFeedResponse) Field2DeepEqual(src *int64) bool {
...
func (p *DouyinFeedResponse) Field3DeepEqual(src *BaseResp) bool {
