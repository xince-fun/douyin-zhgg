...
func QueryRelationByIds(ctx context.Context, currentId int64, userIds []int64) (map[int64]*Follow, error) {
	var relations []*Follow
	...
	relationMap := make(map[int64]*Follow)
	for _, relation := range relations {
		relationMap[relation.FolloweeID] = relation
	}
