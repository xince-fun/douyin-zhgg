...
type DouyinUserRegisterRequest struct {
	...
	Password string `thrift:"password,2,required" form:"password,required" json:"password,required" vd:"len($) < 32"`
}
...
type DouyinUserRequest struct {
	...
	Token  string `thrift:"token,2,required" json:"token,required" query:"user_id,required"`
}
